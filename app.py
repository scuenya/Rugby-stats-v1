...
if uploaded_file is not None:
    # Tries
    df_triesA = df[(df['Row Name']=='TRY') & (df["EQUIPO"] == 'EQUIPO A')]
    if len( df_triesA) != 0:
        triesA = list(df_triesA["Row Name"].value_counts())
    else:
        triesA = 0
   
    df_triesB = df[(df['Row Name']=='TRY') & (df["EQUIPO"] == 'EQUIPO B')]
    if len(df_triesB) != 0:
    ...
    # PENALTY TRIES
    df_p_triesA = df[(df['Row Name']=='PENALTY TRY') & (df["EQUIPO"] == 'EQUIPO A')]
    if len(df_p_triesA) != 0  :
        p_triesA = list(df_p_triesA["Row Name"].value_counts())
    else:
        p_triesA = [0]
    
    df_p_triesB = df[(df['Row Name']=='PENALTY TRY') & (df["EQUIPO"] == 'EQUIPO B')]
    ...
    # GOALS SUCCESS
    df_goalsA = df[(df['Row Name']=='GOAL') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'CONVERTIDO')]
    if len(df_goalsA) != 0  :
        goalsA = list(df_goalsA["Row Name"].value_counts())
    else:
        goalsA = [0]
    
    df_goalsB = df[(df['Row Name']=='GOAL') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"] == 'CONVERTIDO')]
    if len(df_goalsB) != 0  :
   ...
   # GOALS ERROR
    df_no_goalsA = df[(df['Row Name']=='GOAL') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'ERRADO')]
    if len(df_no_goalsA) != 0:
        no_goalsA = list(df_no_goalsA["Row Name"].value_counts())
    else:
        no_goalsA = [0]
    
    df_no_goalsB = df[(df['Row Name']=='GOAL') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"] == 'ERRADO')]
    ...
    df_pen_KickA = df[(df['Row Name']=='PENALTY KICK') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'CONVERTIDO')]
    if len(df_pen_KickA) != 0  :
        pen_KickA = list(df_pen_KickA["Row Name"].value_counts())
    else:
        pen_KickA = [0]
    
    df_pen_KickB = df[(df['Row Name']=='PENALTY KICK') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'CONVERTIDO')]
    ...
    # PENALTY KICK ERRORS
    df_no_pen_KickA = df[(df['Row Name']=='PENALTY KICK') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'ERRADO')]
    if len(df_no_pen_KickA) != 0  :
        no_pen_KickA = list(df_no_pen_KickA["Row Name"].value_counts())
    else:
        no_pen_KickA = [0]
    
    df_no_pen_KickB = df[(df['Row Name']=='PENALTY KICK') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"] == 'ERRADO')]
    ...
    # DROP GOALS
    df_drop_goalsA = df[(df['Row Name']=='DROP') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'CONVERTIDO')]
    if len(df_drop_goalsA) != 0  :
        drop_goalsA = list(df_drop_goalsA["Row Name"].value_counts())
    else:
        drop_goalsA = [0]
    
    df_drop_goalsB = df[(df['Row Name']=='DROP') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"] == 'CONVERTIDO')]
...
# DROP GOALS ERRADO
    df_no_drop_goalsA = df[(df['Row Name']=='DROP') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"] == 'ERRADO')]
    if len(df_no_drop_goalsA) != 0  :
        no_drop_goalsA = list(df_no_drop_goalsA["Row Name"].value_counts())
    else:
        no_drop_goalsA = [0]
    
    df_no_drop_goalsB = df[(df['Row Name']=='DROP') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"] == 'ERRADO')]
    ...
    # YELLOW CARD
    df_yellow_cardA = df[(df['Row Name']=='YELLOW CARD') & (df["EQUIPO"] == 'EQUIPO A')]
    if len( df_yellow_cardA) != 0:
        yellow_cardA = list(df_yellow_cardA["Row Name"].value_counts())
    else:
        yellow_cardA = [0]
   
    df_yellow_cardB = df[(df['Row Name']=='YELLOW CARD') & (df["EQUIPO"] == 'EQUIPO B')]
    ...
    # RED CARD
    df_red_cardA = df[(df['Row Name']=='RED CARD') & (df["EQUIPO"] == 'EQUIPO A')]
    if len(df_red_cardA) != 0:
        red_cardA = list(df_red_cardA["Row Name"].value_counts())
    else:
        red_cardA = [0]
   
    df_red_cardB = df[(df['Row Name']=='RED CARD') & (df["EQUIPO"] == 'EQUIPO B')]
    ...
    # SCRUMS GANADOS
    df_scrumA = df[(df['Row Name']=='SCRUM') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"]== 'GANADO')]
    if len(df_scrumA) != 0:
        scrumA = list(df_scrumA["Row Name"].value_counts())
    else:
        scrumA = [0]

    df_scrumB = df[(df['Row Name']=='SCRUM') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"]== 'GANADO')]
    if len(df_scrumB) != 0:
    ...
    # LINEOUT GANADOS
    df_lineoutA = df[(df['Row Name']=='LINEOUT') & (df["EQUIPO"] == 'EQUIPO A') & (df["RESULTADO"]== 'GANADO')]
    if len(df_lineoutA) != 0:
        lineoutA = list(df_lineoutA["Row Name"].value_counts())
    else:
        lienoutA = [0]
    df_lineoutB = df[(df['Row Name']=='LINEOUT') & (df["EQUIPO"] == 'EQUIPO B') & (df["RESULTADO"]== 'GANADO')]
